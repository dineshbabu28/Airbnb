...
st.set_page_config(page_title="AirBnb-Analysis by DINESH!!!", page_icon=":bar_chart:", layout="wide")
...
if SELECT == "Explore Data":
 ...
 if fl is not None:
    ...
    os.chdir(r"C:\Work\Python\YoutubeData\Airbnb")
...
if SELECT == "Contact":
    Name = (f'{"Name :"}  {"DIN"}')
    mail = (f'{"Mail :"}  {"din@gmail.com"}')
    description = "An Aspiring dta ana..!"
    social_media = {
